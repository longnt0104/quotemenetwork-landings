...
<head>
  ...
  <title>Get Free Siding Quotes | QuoteMeNetwork</title>
  <meta name="description" content="Request free siding quotes from local pros." />
  <style>
...
<input type="hidden" name="_service" value="siding">
      ...
      <section class="step active">
        ...
        <div class="options">
          <button type="button" class="opt" data-set="project_type" data-val="Siding Replacement">
            <strong>Siding Replacement</strong>
            <span>Replace existing siding</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="New Siding Install">
            <strong>New Siding Install</strong>
            <span>Install siding on new/unfinished exterior</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Siding Repair">
            <strong>Siding Repair</strong>
            <span>Fix damaged sections</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Soffit / Fascia">
            <strong>Soffit / Fascia</strong>
            <span>Soffit/fascia repair or replacement</span>
          </button>
        </div>
        <input type="hidden" name="project_type" id="project_type" required>
      </section>
      <section class="step">
        <h2>Siding material preference</h2>
        <div class="options">
          <button type="button" class="opt" data-set="material" data-val="Vinyl">
            <strong>Vinyl</strong>
            <span>Most common, budget-friendly</span>
          </button>
          <button type="button" class="opt" data-set="material" data-val="Fiber Cement">
            <strong>Fiber Cement</strong>
            <span>Durable, premium</span>
          </button>
          <button type="button" class="opt" data-set="material" data-val="Wood / Engineered Wood">
            <strong>Wood / Engineered Wood</strong>
...
<script>
  ...
  const hiddenIds = ["project_type", "material", "stories", "timeline"];
