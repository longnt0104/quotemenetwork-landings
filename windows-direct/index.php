...
<head>
  ...
  <title>Get Free Window Quotes | QuoteMeNetwork</title>
  <meta name="description" content="Request free window quotes from local pros." />
  <style>
    :root {
      --brand: #0077cc;
      --brandDark: #005fa3;
...
<body>
  ...
  <div class="wrap">
    <div class="card">
      ...
      <form id="windowsForm" method="post" action="../process.php" novalidate>
        ...
        <input type="hidden" name="urgency" value="Soon [FAKE VALUE]">
        <input type="hidden" name="home_size" value="1500–3000 sqft [FAKE VALUE]">
        <input type="hidden" name="timeline" value="ASAP [FAKE VALUE]">

        <!-- Contact Form -->
        <section class="step active">

          <div class="field">
            <label for="project_type">What type of windows do you need?</label>
            <select id="project_type" name="project_type" required>
              <option value="" disabled selected>Select an option...</option>
              <option value="Replacement windows">Replacement windows</option>
              <option value="Repair windows">Repair windows</option>
            </select>
          </div>

          <div class="field">
            <label for="answer1">How many windows?</label>
            <select id="answer1" name="answer1" required>
              <option value="" disabled selected>Select an option...</option>
              <option value="1-3 windows">1-3</option>
              <option value="4-7 windows">4-7</option>
  ...
  <script>
    ...
    function validateForm() {
      const requiredFields = ['project_type', 'answer1', 'first_name', 'last_name', 'email', 'phone', 'address', 'zip'];
