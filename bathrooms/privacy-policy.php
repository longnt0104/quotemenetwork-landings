<?php
// privacy-policy.php (QuoteMeNetwork)
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    .card { background: var(--card); border:1px solid var(--border); border-radius: 14px; padding: 28px; box-shadow: 0 10px 24px rgba(0,0,0,0.06); }
    h1 { margin-top: 0; color: #0f172a; }
    h2 { margin-top: 22px; }
    p, li { line-height: 1.5; color: var(--text); }
    ...
    <script
            ...
            data-affonso="cmkobc8n1004eckltlkoj2xxx"
...
<div class="wrap">
  <div class="card">
    ...
    <ul>
      ...
      <li><strong>Project information</strong> you provide (such as project type, budget, timeline).</li>
