...
<head>
  ...
  <title>Get Free Plumbing Quotes | QuoteMeNetwork</title>
  <meta name="description" content="Request free plumbing quotes from local pros." />
  <style>
...
<div class="wrap">
  <div class="card">
    <div class="top">
      <h1>Get Free Plumbing Quotes</h1>
...
<input type="hidden" name="_service" value="plumbing">
      ...
      <section class="step active">
        ...
        <div class="options">
          <button type="button" class="opt" data-set="project_type" data-val="Leak Repair">
            <strong>Leak Repair</strong>
            <span>Pipe leak, fixture leak</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Drain / Clog">
            <strong>Drain / Clog</strong>
            <span>Slow drain, clogged line</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Water Heater">
            <strong>Water Heater</strong>
            <span>Repair/replace water heater</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Toilet Repair">
            <strong>Toilet Repair</strong>
            <span>Running/leaking toilet</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Fixture Install">
            <strong>Fixture Install</strong>
            <span>Faucets, sinks, disposal</span>
          </button>
        </div>
      ...
      <section class="step">
        ...
        <div class="options">
          <button type="button" class="opt" data-set="urgency" data-val="Emergency">
            ...
            <span>Active leak / flooding</span>
          </button>
