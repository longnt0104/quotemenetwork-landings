...
<head>
  ...
  <title>Get Free HVAC Quotes | QuoteMeNetwork</title>
  <meta name="description" content="Request free hvac quotes from local pros." />
  <style>
...
<input type="hidden" name="_service" value="hvac">
      ...
      <section class="step active">
        ...
        <div class="options">
          <button type="button" class="opt" data-set="project_type" data-val="AC Repair">
            <strong>AC Repair</strong>
            <span>Not cooling, leaks, noise</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="AC Replacement">
            <strong>AC Replacement</strong>
            <span>New AC system</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Furnace Repair">
            <strong>Furnace Repair</strong>
            <span>No heat, issues</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Furnace Replacement">
            <strong>Furnace Replacement</strong>
            <span>New heating system</span>
          </button>
          <button type="button" class="opt" data-set="project_type" data-val="Maintenance / Tune-up">
            <strong>Maintenance / Tune-up</strong>
      ...
      <section class="step">
        <h2>Home size</h2>
        <div class="options">
          <button type="button" class="opt" data-set="home_size" data-val="<1500 sqft">
            <strong><1500 sqft</strong>
            <span>Small</span>
          </button>
          <button type="button" class="opt" data-set="home_size" data-val="1500–3000 sqft">
            <strong>1500–3000 sqft</strong>
            <span>Medium</span>
          </button>
          <button type="button" class="opt" data-set="home_size" data-val=">3000 sqft">
            <strong>>3000 sqft</strong>
            <span>Large</span>
          </button>
          <button type="button" class="opt" data-set="home_size" data-val="Not sure">
            <strong>Not sure</strong>
            <span>Estimate needed</span>
          </button>
        </div>
        <input type="hidden" name="home_size" id="home_size" required>
      </section>
      <section class="step">
        <h2>Timeline</h2>
        <div class="options">
...
<script>
  ...
  const hiddenIds = ["project_type", "urgency", "home_size", "timeline"];
